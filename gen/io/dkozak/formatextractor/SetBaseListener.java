...
/**
 * This class provides an empty implementation of {@link SetListener},
 * which can be extended to create a listener which only needs to handle a subset
 * of the available methods.
 */
public class SetBaseListener implements SetListener {
    /**
     * {@inheritDoc}
     *
     ...
     */
    @Override
    public void enterElem(SetParser.ElemContext ctx) {
    }
     ...
     */
    @Override
    public void exitElem(SetParser.ElemContext ctx) {
    }
     ...
     */
    @Override
    public void exitSimpleElement(SetParser.SimpleElementContext ctx) {
    }
